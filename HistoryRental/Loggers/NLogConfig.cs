...
namespace HistoryRental.Loggers
{
    public static class NLogJsonConfiguration
    {
        public static void Configure()
        {
            ...
            {
                Name = "jsonFile",
                FileName = "C:/Users/Jakub/Documents/C#/1 task/HistoryRental/Logs/${shortdate}_log-file.json",
            };
            ...
            var rule = new LoggingRule("HistoryRental.*", NLog.LogLevel.Info, jsonFileTarget);
