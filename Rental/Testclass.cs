...
namespace Rental{
    public class Testclass
    {
        ...
        public async Task Create_CreateCustomer_ReturnsCreated()
        {
            ...
            _libraryService.Setup(c => c.Create(It.IsAny<CreateCustomerDto>())).Returns(Task.FromResult(createdId));
        ...
        {
            var customer = _fixture.Create<CreateCustomerDto>();
            ...
            using(var dbContext = new RentalContext(dbContextOptions))
            {
                ...
                var service = new RentalService(dbContext, mapper, loggerMock.Object);
        ...
        public async Task Delete_ExistingBook_ReturnsTrue()
        {
            ...
            var myLibraryService = new RentalService(dbContext, mapperMock.Object, loggerMock.Object);
        ...
        public async Task Delete_NonExistingCustomer_ThrowsNotFoundException()
        {
            ...
            using (var dbContext = new RentalContext(dbContextOptions))
            {
                ...
                var rentalService = new RentalService(dbContext, mapperMock.Object, loggerMock.Object);
        ...
        public async Task Rent_BookNotAvailable_ThrowsNotFoundException()
        {
            ...
            using (var dbContext = new RentalContext(dbContextOptions))
            {
                ...
                var rentalService = new RentalService(dbContext, mapper, loggerMock.Object);
                await rentalService.Create(createCustomerDto);
                await Assert.ThrowsAsync<NotFoundException>(() => rentalService.Rent(createCustomerDto, bookDto));
            }
        }
    }
}
